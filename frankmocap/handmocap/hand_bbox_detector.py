...
"""REPLACED NMS WITH TORCHVISION.OPS.NMS CAUSE PYCAPSULE CAUSES ERROR IN PYTORCH>=1.7.0"""     
import torchvision
"""REPLACED NMS WITH TORCHVISION.OPS.NMS CAUSE PYCAPSULE CAUSES ERROR IN PYTORCH>=1.7.0"""
...
"""ADDED THIS PATH FOR IMPORTING PYTHON FILES IN FRANKMOCAP/DETECTORS/HAND_OBJECT_DETECTOR/LIB"""
sys.path.append('/home/hansookwan/MAIN/Ego4d_Codes/github_codes/frankmocap/detectors/hand_object_detector/lib')
# print(sys.path)
    ...
    def __get_raw_hand_bbox(self, img):
        with torch.no_grad():
            ...
            if inds.numel()>0:
                ...
                """REPLACED NMS WITH TORCHVISION.OPS.NMS CAUSE PYCAPSULE CAUSES ERROR IN PYTORCH>=1.7.0"""              
                keep = torchvision.ops.nms(cls_boxes, cls_scores, cfgg.TEST.NMS)
