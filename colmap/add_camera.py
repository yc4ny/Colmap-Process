...
def main():
    # Set the paths
    image_path = "preprocessed/region_left"
    existing_reconstruction_path = "colmap/data_undistort"
    ...
    # Feature extraction
    feature_extractor_cmd = f"colmap feature_extractor --image_path {image_path} --database_path {database_path} --ImageReader.single_camera_per_folder 1"
